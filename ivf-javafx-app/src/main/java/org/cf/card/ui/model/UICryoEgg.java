...
public class UICryoEgg {
	...
	public UICryoEgg(Long id,int srNo, String quality, String date, boolean action) {
	...
	public UICryoEgg(Long id,int srNo, String date) {
		this.id=  new SimpleLongProperty(id);
		this.srNo = new SimpleIntegerProperty(srNo);
		this.date = new SimpleStringProperty(date);
	}

	public UICryoEgg(int srNo, String quality){
		this.srNo = new SimpleIntegerProperty(srNo);
		this.quality = new SimpleStringProperty(quality);
	}
